package spjportal;
	...
	public class Course {
		static Logger log = LogManager.getLogger(Course.class);
		@Test(priority=2)
		public void Course(Method method) throws InterruptedException {
			System.out.println("\n Welcome \n");
		 		...
		 		Reporter.log("Login to the WorkBench",true);
		 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
		 			...
		 			Reporter.log("Clear the Extra API On the URI ",true);
		 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/TimeTable?course=BBAECO103-Macroeconomics");

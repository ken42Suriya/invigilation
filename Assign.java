package spjportal;
		...
		public class Assign {
			static Logger log = LogManager.getLogger(Assign.class);
			@Test(priority=2)
			public void Assign(Method method) throws InterruptedException {
				System.out.println("\n Welcome \n");
			     ...
			     WebDriverManager.chromedriver().setup();
					...
					Reporter.log( "Maximize the Browser", true );
			         ...
			         driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[3]/td[10]/div/div/a[1]")).click();
			         Thread.sleep(1000);
			         driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/div[2]/div/div/table/tbody/tr[1]/td[5]/button")).click();
			         Thread.sleep(1000);
			         driver.findElement(By.xpath("//*[@id=\"mui-component-select-venue_link\"]")).click();
			         Thread.sleep(1000);
			         driver.findElement(By.xpath("//*[@id=\"menu-venue_link\"]/div[3]/ul/li[1]")).click();
			         Thread.sleep(1000);
			         driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/div[2]/div/div/table/tbody/tr[1]/td[5]/button[1]")).click();
			         Thread.sleep(1000);
				         
			         
			         List<WebElement> row = driver.findElements(By.xpath("/html/body/div[1]/div/div/div/div[2]/div/div/div[2]/div/div/table/tbody/tr"));
			 		...
			 		Reporter.log("Login to the WorkBench",true);
			 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
			 			...
			 			Reporter.log("Clear the Extra API On the URI ",true);
			 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/InvigilatorDetails?examId=a121y000000JJveAAG");
			 			 ...
			 			 Reporter.log("on the api Testing Here We fillter term in BBA Term 1 ",true);
			 				...
			 				log.info("======================RESPONSE FROM THE API====================");
			 				 ...
			 				 log.info("[\r\n"
			 				 		...
			 				 		+ "          }\r\n"
			 				 		+ "        ],\r\n"
			 				 		+ "        \"name\": \"ken42 faculty 3\",\r\n"
			 				 		+ "        \"isAllocated\": \"Not Assigned\",\r\n"
			 				 		+ "        \"faucltyId\": \"0031y00000JQP6RAAX\",\r\n"
			 				 		+ "        \"facEmail\": \"giri2k3@gmail.com\",\r\n"
			 				 		+ "        \"allocatedRoomNo\": \"\"\r\n"
			 				 		+ "      },\r\n"
			 				 		+ "      {\r\n"
			 				 		+ "        \"subject\": [],\r\n"
			 				 		+ "        \"name\": \"ken42 faculty 4\",\r\n"
			 				 		+ "        \"isAllocated\": \"Not Assigned\",\r\n"
			 				 		+ "        \"faucltyId\": \"0031y00000JQP6SAAX\",\r\n"
			 				 		+ "        \"facEmail\": null,\r\n"
			 				 		+ "        \"allocatedRoomNo\": \"\"\r\n"
			 				 		+ "      },\r\n"
			 				 		+ "      {\r\n"
			 				 		...
			 				 		+ "          }\r\n"
			 				 		+ "        ],\r\n"
			 				 		+ "        \"name\": \"ken42 faculty 1\",\r\n"
			 				 		+ "        \"isAllocated\": \"Not Assigned\",\r\n"
			 				 		+ "        \"faucltyId\": \"0031y00000JQP6PAAX\",\r\n"
			 				 		+ "        \"facEmail\": \"faculty@ken42.com\",\r\n"
			 				 		+ "        \"allocatedRoomNo\": \"\"\r\n"
			 				 		+ "      }\r\n"
			 				 		+ "    ]\r\n"
			 				 		+ "  }\r\n"

...
package spjportal;
	...
	public class Term{
		static Logger log = LogManager.getLogger(Term.class);
		@Test(priority=2)
		public void Term(Method method) throws InterruptedException {
			System.out.println("\n Welcome \n");
		     ...
		     WebDriverManager.chromedriver().setup();
				...
				Reporter.log( "Maximize the Browser", true );
		         ...
		         driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/header/div/div/button")).click();
		         Thread.sleep(1000);
		 		...
		 		Reporter.log("Login to the WorkBench",true);
		 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
		 			...
		 			Reporter.log("Clear the Extra API On the URI ",true);
		 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/TimeTable?term=BBA+Term+1+Master&course=BBALIB106-World+Cultures");
		 			 ...
		 			 Reporter.log("on the api Testing Here We fillter term in BBA Term 1 ",true);
		 				...
		 				log.info("To show the Response came from Salesforce & the record count 2");
		 				 Reporter.log("To show the Response came from Salesforce & the record count 2 ",true);

package spjportal;
	...
	public class sDate {
		static Logger log = LogManager.getLogger(sDate.class);
		@Test(priority=2)
		public void sDate(Method method) throws InterruptedException {
			System.out.println("\n Welcome \n");
		     ...
		     WebDriverManager.chromedriver().setup();
				...
				Reporter.log( "Maximize the Browser", true );
		         ...
		         Thread.sleep(1000);
		         driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div[3]/div/div[2]/input")).sendKeys("15-08-2022");
		         Thread.sleep(1000);
		 		...
		 		Reporter.log("Login to the WorkBench",true);
		 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
		 			...
		 			Reporter.log("Clear the Extra API On the URI ",true);
		 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/TimeTable?course=&date=2022-08-15");
